		...
		if( get_post_meta( get_the_ID(), 'image_embed', true ) ) { 
			...
			if( is_single() ){
				...
				if( function_exists( 'aq_resize' ) ){
					echo '<div class="post-preview"><a href="'. esc_url(get_permalink()) .'" class="local-image"><img alt="'.esc_attr(get_the_title()).'" src="'. aq_resize($img_url, 800, 500, true, true, true) .'" /></a></div>';
				} else {
