	...
	<article id="post-<?php the_ID(); ?>" <?php post_class('post-entry clearfix'); ?> role="article">
		...
		<header class="post-entry-header">
			<div class="quoute-text">
				<h2 class="entry-title"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'quince' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php echo get_the_content(); ?></a></h2>
